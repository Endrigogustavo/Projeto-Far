    ...
    public Funcionarios() throws SQLException, ParseException{
        ...
        new Object [][]{
            ...
            {null, null, null, null, null, null, null},
                ...
                new String [] {"Código", "Nome", "Usuário", "Nivel_ID", "Senha", "Email", "Data_Nasc", "CPF"})
        {
    ...
    public boolean isCellEditable(int rowIndex, int columnIndex){
      ...
      public void mostrar_Dados(){
        try{
            ...
            tData.setText(con_cliente.resultset.getString("Usuário"));
            tTel.setText(con_cliente.resultset.getString("Nivel_ID"));
            tEmail.setText(con_cliente.resultset.getString("Senha"));
            tEmail2.setText(con_cliente.resultset.getString("Email"));
            tEmail3.setText(con_cliente.resultset.getString("Data_Nasc"));
